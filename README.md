...
_**UDP Technology**_([http://www.udptechnology.co.kr](http://www.udptechnology.co.kr))는 자타가 공인하는 세계 최고의 디지털 영상 보안 시스템의 핵심 기술을 개발하고 있으며, 국제 규격의 영상분석 원천기술을 자체 보유하여 세계 수준의 가격 경쟁력과 높은 적용성의 지능형 영상분석 엔진과 솔류션을 동시에 갖춘 기업입니다.

한국에 본사와 기술연구소를 두고 미국, 영국, 중국에 지사와 해외연구소가 있습니다.
수출이 매출의 90%이상을 차지하며, 세계 40여개국의 280여 바이어들이 있는 명실상부한 글로벌 기업입니다.
유디피는 끊임없는 기술개발과 도전으로 급변하는 디지털 영상 보안 시장을 이끌어 가고 있습니다.

Cloud Team은 유디피가 꿈꾸는 미래를 그려가는 곳입니다.
세계 최고의 디지털 영상 보안 기술과 지능형 영상분석 기술을 이용한 Cloud 기반의 Platform과 Solution을 함께 만들어 갈 UI/UX Designer를 찾고 있습니다.

새로운 분야에서 또다시 세계 최고가 되고자 하는 유디피는 함께 최고가 될 당신의 능력과 열정을 기다리고 있습니다.
...
# 우리 팀(Cloud Team)은 이렇게 일해요
 ...
 - Git과 Bitbucket을 이용한 소스코드의 관리

 - Pull Request를 이용한 Code Review

 - 스크럼 방식의 Agile을 이용한 린 스타트업을 추구

 - Ondemand Bamboo CI를 통해 테스팅/빌드 및 AWS Beanstalk으로 배포

 - Stack을 이용한 업무 커뮤니티 효율 향상

 - Jira를 이용한 이슈 관리와 QA팀의 버그 추적
...
# 이런 UI/UX Designer를 찾고 있습니다

### 담당업무

 - Cloud Team 신규 서비스 UI 및 UX 디자인

### 자격

 - 포토샵, 일러스트레이터 등을 활용한 UI 리소스의 제작 능력 보유

 - 뛰어난 디자인적 감각 및 UX에 대한 충분한 이해도 보유
...
### 근무지
 ...
 - (주)유디피 본사: 서울 강서구 염창동 우림블루나인 4층 A동
